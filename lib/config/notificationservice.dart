...
class NotificationService {
  ...
  Future<void> initNotification() async {
    ...
    FirebaseMessaging.onMessage.listen((message) async {
      ...
      final notificationDrammpDriver =
          jsonDecode(prefs.getString('notificationDrammpDriver') ?? '[]');
      List<NotificationModel> notificationsmodel =
          (notificationDrammpDriver as List)
      ...
      prefs.setString(
          'notificationDrammpDriver', jsonEncode(notificationsmodel));
